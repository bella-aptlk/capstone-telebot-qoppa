...
def send_welcome(message):
    ...
    full_name = first_name #f'{first_name} {last_name}' if last_name is not None else first_name
...
def send_about(message):
    ...
    with open('template_text/about.txt', mode='r', encoding='utf-8') as f:
        ...
        about = temp.substitute(
            ...
            GITHUB_REPO_LINK = 'https://github.com/bella-aptlk/capstone-telebot-qoppa'
        )
...
def send_plot(message):
    ...
    if selected_campaign_id in unique_campaign:
        ...
        df_campaign = df[df['campaign_id']==selected_campaign_id]
        df_plot = df_campaign.groupby(by="age").agg({'spent' : 'sum','approved_conversion' : 'sum'})
...
def echo_all(message):
    ...
    with open('template_text/default.txt', mode='r', encoding='utf-8') as f:
        ...
        default = temp.substitute(EMOJI = emoji.emojize(":zipper-mouth_face:"))
